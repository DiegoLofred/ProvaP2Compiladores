...
import com.mycompany.alguma2.ide.contentassist.antlr.Alguma2Parser;
import com.mycompany.alguma2.ide.contentassist.antlr.PartialAlguma2ContentAssistParser;
import com.mycompany.alguma2.ide.contentassist.antlr.internal.InternalAlguma2Lexer;
import com.mycompany.alguma2.ui.contentassist.Alguma2ProposalProvider;
import com.mycompany.alguma2.ui.editor.Alguma2Editor;
import com.mycompany.alguma2.ui.labeling.Alguma2DescriptionLabelProvider;
import com.mycompany.alguma2.ui.labeling.Alguma2LabelProvider;
import com.mycompany.alguma2.ui.outline.Alguma2OutlineTreeProvider;
import com.mycompany.alguma2.ui.quickfix.Alguma2QuickfixProvider;
import com.mycompany.alguma2.validation.Alguma2ValidatorConfigurationBlock;
...
/**
 * Manual modifications go to {@link Alguma2UiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractAlguma2UiModule extends DefaultXbaseUiModule {

	public AbstractAlguma2UiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(com.mycompany.alguma2.parser.antlr.internal.InternalAlguma2Lexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return Alguma2Parser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalAlguma2Lexer.class).toProvider(LexerProvider.create(InternalAlguma2Lexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return Alguma2ValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return Alguma2LabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(Alguma2DescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return Alguma2OutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return Alguma2QuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return Alguma2ProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialAlguma2ContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Alguma2 Compare");
	}
