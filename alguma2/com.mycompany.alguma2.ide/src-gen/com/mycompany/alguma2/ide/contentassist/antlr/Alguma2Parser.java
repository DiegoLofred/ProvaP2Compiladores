 ...
 */
package com.mycompany.alguma2.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import com.mycompany.alguma2.ide.contentassist.antlr.internal.InternalAlguma2Parser;
import com.mycompany.alguma2.services.Alguma2GrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class Alguma2Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(Alguma2GrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, Alguma2GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAlgoritmoAccess().getGroup(), "rule__Algoritmo__Group__0");
			builder.put(grammarAccess.getAlgoritmoAccess().getGroup_1(), "rule__Algoritmo__Group_1__0");
			...
			builder.put(grammarAccess.getProgramaAccess().getAlgoritmoAssignment_5(), "rule__Programa__AlgoritmoAssignment_5");
			builder.put(grammarAccess.getAlgoritmoAccess().getExpressionsAssignment_1_0(), "rule__Algoritmo__ExpressionsAssignment_1_0");
			builder.put(grammarAccess.getDeclaracaoAccess().getNomeAssignment_0(), "rule__Declaracao__NomeAssignment_0");
	...
	@Override
	protected InternalAlguma2Parser createParser() {
		InternalAlguma2Parser result = new InternalAlguma2Parser(null);
