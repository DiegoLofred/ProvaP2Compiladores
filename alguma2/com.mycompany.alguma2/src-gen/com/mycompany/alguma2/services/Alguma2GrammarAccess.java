 ...
 */
package com.mycompany.alguma2.services;
...
@Singleton
public class Alguma2GrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	
	public class ProgramaElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.mycompany.alguma2.Alguma2.Programa");
		...
		private final Assignment cAlgoritmoAssignment_5 = (Assignment)cGroup.eContents().get(5);
		private final RuleCall cAlgoritmoAlgoritmoParserRuleCall_5_0 = (RuleCall)cAlgoritmoAssignment_5.eContents().get(0);
		
		//Programa : ':' 'DECLARACOES' (declaracoes+=Declaracao)+ ':' 'ALGORITMO' algoritmo=Algoritmo;
		@Override public ParserRule getRule() { return rule; }
		
		//':' 'DECLARACOES' (declaracoes+=Declaracao)+ ':' 'ALGORITMO' algoritmo=Algoritmo
		...
		//algoritmo=Algoritmo
		public Assignment getAlgoritmoAssignment_5() { return cAlgoritmoAssignment_5; }
		
		//Algoritmo
		public RuleCall getAlgoritmoAlgoritmoParserRuleCall_5_0() { return cAlgoritmoAlgoritmoParserRuleCall_5_0; }
	}
	public class AlgoritmoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.mycompany.alguma2.Alguma2.Algoritmo");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DeclaracaoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.mycompany.alguma2.Alguma2.Declaracao");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cNomeAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cNomeIDTerminalRuleCall_0_0 = (RuleCall)cNomeAssignment_0.eContents().get(0);
		...
		//ID
		public RuleCall getNomeIDTerminalRuleCall_0_0() { return cNomeIDTerminalRuleCall_0_0; }
	...
	public class TipoVarElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.mycompany.alguma2.Alguma2.TipoVar");
	...
	@Inject
	public Alguma2GrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("com.mycompany.alguma2.Alguma2".equals(grammar.getName())) {
				return grammar;
			}
