...
public class Alguma2SyntacticSequencer extends AbstractSyntacticSequencer {

	protected Alguma2GrammarAccess grammarAccess;
	protected AbstractElementAlias match_Algoritmo_SemicolonKeyword_1_1_q;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (Alguma2GrammarAccess) access;
		match_Algoritmo_SemicolonKeyword_1_1_q = new TokenAlias(false, true, grammarAccess.getAlgoritmoAccess().getSemicolonKeyword_1_1());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_Algoritmo_SemicolonKeyword_1_1_q.equals(syntax))
				emit_Algoritmo_SemicolonKeyword_1_1_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 * </pre>
	 */
	protected void emit_Algoritmo_SemicolonKeyword_1_1_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
